...
function mdp_text(to_append) {
	var text = "<p class=\"white text-body-raleway center\" style=\"opacity: 0\"><b><span class=\"white\">Multidisciplinary Design Program</span></b> with <b>MDA Information Systems</b><br>Ypsilanti, MI | Winter '16 - Fall '16</p>\
							<p class=\"white text-body-raleway-subtext experience-subtext justified\"><span class=\"tab\"><b><span class=\"cyan\">></span></b> Research, design, and implement a camera-based <span class=\"cyan\"><b>polar bear detection system</b></span> to protect workers in Arctic environments.</span></p>\
							...
							<p class=\"white text-body-raleway-subtext experience-subtext justified\"><span class=\"tab\"><b><span class=\"cyan\">></span></b> Research and utilize <span class=\"cyan\"><b>computer vision</b></span> to calculate speed, distance, and bearing (SBD) from bounding box movements. Then, design and implement a <span class=\"cyan\"><b>graphical interface using OpenGL</b></span> to display SBD.</span></p>\
							<p class=\"white text-body-raleway-subtext experience-subtext justified\"><span class=\"tab\"><b><span class=\"cyan\">></span></b> Supply weekly written summaries and agendas to the client, MDA Information Systems.</span></p>";
